...
namespace Caelan.Frameworks.BIZ.Classes
{
    public static class GenericBusinessBuilder
    {
            ...
            where TDestination : class, IDTO, new()
        {
            ...
            var customBuilder = Assembly.GetCallingAssembly().GetReferencedAssemblies().OrderBy(t => t.Name).Select(Assembly.Load).SelectMany(assembly => assembly.GetTypes().Where(t => t.BaseType == builder.GetType())).SingleOrDefault();
